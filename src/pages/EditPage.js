...
function EditPage() {
  ...
  let createBlock = (content, id) => {
    ...
    switch (content) {
      ...
      case "이미지2":
        return (
          <ThreeImage id={id} dataList={dataList} setDataList={setDataList} />
        );

      case "도형1":
        return (
          <AboutMe id={id} dataList={dataList} setDataList={setDataList} />
        );
  ...
  const Item = styled.div`
    ...
    border: 1px
      ${(props) =>
        props.isdragging == "true" ? "dashed #4099ff" : "solid #ddd"};
  `;
  ...
  const List = styled.div`
    border: 1px
      ${(props) =>
        props.isdraggingover == "true" ? "dashed #000" : "solid #ddd"};
    background: #fff;
      ...
      <div className="category-container">
        ...
        <div className="category-item-container">
          <div
            ...
            ref={(el) => {
              categoryBtnRef.current[0] = el;
            }}
            onClick={() => {
              flip(0);
            }}
          >
            <div className="category-item-front">
              <BiCube />
            </div>
            <div className="category-item-back">
              <p>도형</p>
            </div>
          </div>
        </div>
